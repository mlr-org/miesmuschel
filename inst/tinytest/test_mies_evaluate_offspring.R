...
expected_archive = rbind(expected_archive,
  data.table(p1 = 3:1, bud = 4, dob = 3, eol = NA_real_, pout1 = 3:1, x_domain = lapply(3:1, function(x) (list(p1 = x, bud = 4))), batch_nr = 3))
expect_equal(copy(oismall$archive$data)[, timestamp := NULL], expected_archive, ignore.col.order = TRUE)
...
expected_archive = rbind(expected_archive,
  data.table(p1 = c(5, 7), bud = 1, dob = 4, eol = NA_real_, pout1 = c(5, 7), x_domain = lapply(c(5, 7), function(x) (list(p1 = x, bud = 1))), batch_nr = 4))
expected_archive = rbind(expected_archive,
  data.table(p1 = c(1, 1, 2), bud = 3, dob = 4, eol = NA_real_, pout1 = c(1, 1, 2), x_domain = lapply(c(1, 1, 2), function(x) (list(p1 = x, bud = 3))), batch_nr = 4))
expect_equal(copy(oismall$archive$data)[, timestamp := NULL], expected_archive, ignore.col.order = TRUE)
...
expected_archive = rbind(expected_archive,
  data.table(p1 = c(5, 7), bud = 3, dob = 5, eol = NA_real_, pout1 = c(5, 7), x_domain = lapply(c(5, 7), function(x) (list(p1 = x, bud = 3))), batch_nr = 5))
expected_archive = rbind(expected_archive,
...
expected_archive = rbind(expected_archive,
  data.table(p1 = c(5, 7), bud = 1, dob = 6, eol = NA_real_, pout1 = c(5, 7), x_domain = lapply(c(5, 7), function(x) (list(p1 = x, bud = 1))), batch_nr = 6))
expect_equal(copy(oismall$archive$data)[, timestamp := NULL], expected_archive, ignore.col.order = TRUE)
