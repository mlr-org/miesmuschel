...
munifmaybe = MutatorMaybe$new(munif)
munifmaybe$param_set$values$p = .5
munifmaybe$prime(p)
operated = munifmaybe$operate(data.table(x = rep(TRUE, 100), y = rep("FALSE", 1000)))
...
munifmaybe$param_set$values$maybe.can_mutate_to_same = FALSE
