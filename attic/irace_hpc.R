...
# 1000 irace budget
dir.create("./attic/data_06_05_b1000")

future::plan("multicore", workers = 10)
instance_file = "./attic/data_06_05_b1000/irace_instance.rda"
log_file = "./attic/data_06_05_b1000/irace_log.Rdata"
...
# 52*100*8 smashy budget 
# 3000 irace budget
dir.create("./attic/data_07_05_single_b3000")
instance_file = "./attic/data_07_05_single_b3000/irace_instance.rda"
log_file = "./attic/data_07_05_single_b3000/irace_log.Rdata"
...
res = optimize_irace(c("val_balanced_accuracy"), c("test_balanced_accuracy"), task_levels, cfg, 3000, instance_file, log_file)
